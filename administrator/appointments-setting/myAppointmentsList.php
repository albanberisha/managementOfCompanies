                ...
                <table class="table" id="ClientList">
                    <tr>
                        ...
                        */
                        ...
                        <?php
                        $sql1 = "SELECT appointments.id,clients.name,clients.surname,appointments.shdesc,appointments.date,appointments.startTime,appointments.endTime ,appointments.status from clients,appointments where appointments.clientId=clients.id and appointments.status='1' and appointments.userId IN (Select id from users where companyId='$companyId') ORDER BY appointments.date DESC";
                        $res1 = $con->query($sql1);
                        if ($res1->num_rows > 0) {
                            $i = 1;
