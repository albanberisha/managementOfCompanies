...
<div class="row">
    ...
    <div class="row">
        <div class="col">
            <div class="row">
                <form id="SearchFormMyApp2" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col searchTpt3">
                            ...
                            <div class="form-group">
                                <a href="dashboard.php?cat=appointments-setting&subcat=canceledAppointments" class="btn btn-secondary btn-back content-link"><i class="fas fa-sync"></i></a>
            ...
            <table class="table" id="ClientList">
                    <tr>
                        ...
                        <?php
                        $sql1 = "SELECT clients.name,clients.surname,appointments.id,appointments.shdesc,appointments.date,appointments.startTime,appointments.endTime ,appointments.status from clients,appointments where appointments.userId IN (Select id from users where companyId='$companyId') and appointments.clientId=clients.id and appointments.status='2' ORDER BY appointments.date DESC";
                        $res1 = $con->query($sql1);
                        if ($res1->num_rows > 0) {
                            $i = 1;
