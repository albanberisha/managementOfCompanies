...
<div class="row">
        <div class="col">
            <h4>Tërminet e caktuara nga unë dhe të anuluara</h4>
        </div>
        ...
        <div class="col">
            ...
            <table class="table" id="ClientList">
                    <tr>
                        ...
                        <?php
                        $sql1 = "SELECT clients.name,clients.surname,appointments.shdesc,appointments.date,appointments.startTime,appointments.endTime ,appointments.status from clients,appointments where appointments.userId='$myid' and appointments.clientId=clients.id and appointments.status='2' ORDER BY appointments.dateTime DESC";
                        $res1 = $con->query($sql1);
                        if ($res1->num_rows > 0) {
                            $i = 1;
