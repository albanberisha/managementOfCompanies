...
<head>
	...
	<style>
		...
		.custom-checkbox .custom-control-input:checked~.custom-control-label::before {
			background-color: #52b82a !important;
		}
			...
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img src="images/logoBit2.png" class="brand_logo" alt="Logo">
					</div>
				</div>
...
<script>
  ...
  case "1":
    ...
    break;
	case "2":
    $message="Paswordi jo korrekt.";
    $('#Pasworderror').html($message);
    document.getElementById('Pasworderror').scrollIntoView({ behavior: 'smooth', block: 'center' });
    break;
  default:
