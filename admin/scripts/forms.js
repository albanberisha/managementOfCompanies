...
$("#UpdateCompanyForm").submit(function(e) {
    ...
    $('#Nameerror').html("");
    $('#Phoneerror').html("");
    var myform = document.getElementById("UpdateCompanyForm");
    var fd = new FormData(myform);
    $.ajax({
            url: "scripts/updateCompany.inc.php",
            data: fd,
            cache: false,
            processData: false,
            contentType: false,
...
$("#AddCompanyForm").submit(function(e) {
    ...
    var fd = new FormData(myform);
    $.ajax({
            url: "scripts/addCompany.inc.php",
            data: fd,
            cache: false,
            processData: false,
            contentType: false,
        ...
        .done(function(response) {
            ...
            switch (response) {
                ...
                case "2":
                    ...
                    break;
                case "3":
                    $message = "Zgjidhni njeren nga kompanite!";
                    $('#Comperror').html($message);
                    document.getElementById('Comperror').scrollIntoView({
                        behavior: 'auto',
                        block: 'center',
                        inline: 'center'
                    });
                ...
                default:
                    ...
                    document.getElementById("Cpassword").value = '';
                    window.scrollTo(0, 0);
                    message = "<span class='success'>Te dhenat u ruajten me sukses!.</span>";
                    $('#alertBox').html(message).fadeIn();
