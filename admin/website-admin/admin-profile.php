...
<div class="content-box">
	...
	if ($_GET['subcat'] == 'add-admin-profile') {
		...
		<br>
		<form id="AddUSerForm" name="change_password" class="needs-validation" method="post">
			<div class="row">
				<div class="col">
				...
				<div class="col">
					<div class="form-group">
						...
						<input type="text" placeholder="Mbiemri" class="form-control" name="surname" id="Surname">
			...
			<div class="row">
				<div class="col">
					<div class="form-group">
						<label for="companies"><strong>Zgjidhni kompanine: <span  style="color: red;">*</span></strong></label>
<select class="form-control" id="Companies" name="companies">
<option value="-1">Zgjedhni kompanine</option>
<?php
...
<span id="Comperror" style="color: red;"></span>
			...
			<div class="row">
				...
				<div class="col">
					<div class="form-group">
						...
						<input type="date" placeholder="Datelindja" class="form-control" name="birthday">
					</div>
				</div>
				<div class="col">
					<div class="form-group">
				...
				<div class="table-responsive">
					<table class="table">
						<tr>
							...
							<th>Privilegji</th>
							<th>Regjistruar</th>
							<th>Hera e fundit e perditesimit</th>
						</tr>
						<?php
						$sql1 = "SELECT * FROM users where privilege='3' and status!=2 and companyId='$comp'";
						$res1 = $con->query($sql1);
						if ($res1->num_rows > 0) {
							$i = 1;
						...
						?>
							...
							?>
							<tr>
								<td colspan="6">No Profile Data</td>
							</tr>
						<?php } ?>
			...
			<div class="col">
				<div class="table-responsive">
					<table class="table">
						...
						<?php
						$sql1 = "SELECT * FROM users where privilege!='3' and status!=2";
						$res1 = $con->query($sql1);
						if ($res1->num_rows > 0) {
							$i = 1;
							while ($data = $res1->fetch_assoc()) {
						?>
								<tr>
									...
									$sql2 = "SELECT * FROM companies where id='$companyId'";
									$res2 = $con->query($sql2);
...
<?php
									...
									<td><a href="dashboard.php?cat=website-admin&subcat=admin-profile&edit=<?php echo $data['id']; ?>" class="text-success edit_button_color"><i class=' far fa-edit'></i></a></td>
									<td></td>
